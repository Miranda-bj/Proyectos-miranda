'''
Soy Miranda sin duda mi lenguaje favorito es python funciona bien en todo aspecto "base de datos, ciberseguridad, backend, etc.."
les comparto todo lo que he aprendido de manera autodidacta de muchos libros y videos que he podido ver y leer 
del lenguaje python espero les sea de ayuda.
'''
# Introducción
